...
function criarElemento(){
    ...
    box.setAttribute("id","bx1");

    // box.addEventListener("click", mostrarMensagem );
    box.addEventListener("click", deletarElemento );
    box.addEventListener("mouseover", mudarCor );
...
function deletarElemento(){
    var box = document.getElementById("bx1");
    box.remove();
}
...
function validarQuantidade(){
    ...
    var spnValidar = document.getElementById("spnValidar");

    var msg;
    if (qtd>5){
        msg = "incorreto";
        spnValidar.style.backgroundColor = "red";
    }else{
        msg = "correto";
        spnValidar.style.backgroundColor = "green";
    }

    spnValidar.style.color = "white";
    spnValidar.style.borderRadius = "5px";

    // var msg = (qtd>5)?"incorreto":"correto";

    spnValidar.textContent = msg;
